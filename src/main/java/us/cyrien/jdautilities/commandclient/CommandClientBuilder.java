 ...
 */
package us.cyrien.jdautilities.commandclient;

import us.cyrien.jdautilities.commandclient.impl.CommandClientImpl;
...
public class CommandClientBuilder {
    ...
    private Function<CommandEvent, EmbedBuilder> helpFunction;
     ...
     *
     * @param  helpFunction
     *         A function to convert a {@link CommandEvent CommandEvent}
     *         to a String for a help DM.
     *
     * @return This builder
     */
    public CommandClientBuilder setHelpFunction(Function<CommandEvent, EmbedBuilder> helpFunction)
    {
    ...
    /**
     * Sets the <a href="https://discordbots.org/">Discord Bot ListCmd</a> API key for this bot's listing.
     * 
     * <p>When set, the {@link CommandClientImpl CommandClientImpl}
     * will automatically update it's Discord Bot ListCmd listing with relevant information such as server count.
     * 
     * @param  key
     *         A Discord Bot ListCmd API key
     *         
     * @return This builder
     */
