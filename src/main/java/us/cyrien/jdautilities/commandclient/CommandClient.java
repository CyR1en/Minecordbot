 ...
 *
 *         <p><b>5)</b> Avoid using {@link CommandClientImpl#linkIds(long, net.dv8tion.jda.core.entities.Message)}.
...
public interface CommandClient {
     ...
     * during this session.
     * 
     * @return A never-null ListCmd of Commands registered during this session
     */
     ...
     * 
     * <p>This allows it to be cancelled later using {@link CommandClient#cancel(String) CommandClient#cancel(String)}.
     *
     * @param  <T>
     ...
     * {@link CommandClient#cleanSchedule() CommandClient#cleanSchedule()}
     ...
     * cancellation even in mid-operation use {@link CommandClient#cancelImmediately(String) CommandClient#cancelImmediately(String)}.
     * 
     * @param  name 
     *         The name of the ScheduledFuture
     */
