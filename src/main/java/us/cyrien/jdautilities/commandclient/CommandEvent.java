...
public class CommandEvent {
    ...
    /**
     * Gets the {@link net.dv8tion.jda.core.entities.TextChannel TextChannelCmd} that this CommandEvent
     * may have taken place on, or {@code null} if it didn't happen on a TextChannelCmd.
     * 
     * @return The TextChannelCmd this CommandEvent may have taken place on, or null
     *         if it did not happen on a TextChannelCmd.
     */
